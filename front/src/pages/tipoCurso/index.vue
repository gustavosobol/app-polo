<template>
  <div class="q-pa-md q-gutter-sm">
    <q-dialog @hide="returnTipoCurso" v-model="toolbar">
      <q-card>
        <q-toolbar>
          <q-space />
    ...
    <div class="q-pa-md">
      ...
      >
        <template v-slot:top>
          <div class="col-2 q-table__title">Tipo Curso</div>
          <q-space />
          <q-input
            borderless
            dense
...
import AddTipoCurso from "src/components/tipoCurso/AddTipoCurso.vue";
