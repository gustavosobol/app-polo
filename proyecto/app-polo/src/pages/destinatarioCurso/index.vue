<template>
  <div class="q-pa-md q-gutter-sm">
    ...
    <div class="q-pa-md">
      ...
      >
        <template v-slot:top>
          <div class="col-2 q-table__title">Curso Destinatario</div>
          <q-space />
          <q-input
            borderless
            dense
...
import AddCursoDestinatario from "../../components/destinatarioCurso/AddCursoDestinatario.vue";
...
export default {
  ...
  components: { AddCursoDestinatario },
};
</script>
