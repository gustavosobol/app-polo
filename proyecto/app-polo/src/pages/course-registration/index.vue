  ...
  <q-item to="/alumnos/5" exact>
          ...
          <q-dialog v-model="prompt" persistent>
              <q-card style="min-width: 350px">
                ...
                <q-card-section class="q-pt-none">
                  <q-input dense v-model="doc" autofocus @keyup.enter="prompt = false" />
                </q-card-section>

                <q-card-actions align="right" class="text-primary">
                  <q-btn flat label="Cancel"   v-close-popup />
                  <q-btn to="/alumnos/" flat label="Add address" v-close-popup />

                    <router-link class="q-pa-md" :to="{ name: 'Alumnos', params: {idCurso: actual, idAlumno: doc }}">
                    <q-btn outline>Usa este</q-btn>
                    </router-link>
   ...
   <template v-slot:header="props">
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td auto-width>
            <q-btn size="sm" color="primary" style="height: 35px" @click="props.expand = !props.expand" :icon="props.expand ? 'warning' : 'add'" />
            
          </q-td>
          <q-td auto-width>
            <q-btn label="Agregar Alumno" color="primary" @click="prompt = true,  actual = String(props.row.nombre) "  />
        ...
        <q-tr v-show="props.expand" :props="props">
          <q-td colspan="100%">
            <div class="text-left">Descripcion :  Descripcion Descripcion Descripcion {{ props.row.nombre }}.</div>
            <div class="text-left">Descripcion :  Mas info      {{ props.row.nombre }}.</div>
